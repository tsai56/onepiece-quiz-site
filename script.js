...
const questions = [
  ...
  { q:"夥伴遇到危機時，你最可能？", a:[["luffy","直接衝過去，邊跑邊喊他的名字"],["zoro","冷靜出手，事情交給我"],["nami","先判斷局勢，找出最有效的解法"],["sanji","優雅登場，順便說一句帥話"],["usopp","嘴上說完蛋了，手已經開始出招"],["chopper","先救人，再把對方罵到知道錯"]]},
  ...
  { q:"如果你是草帽海賊團成員，最想負責？", a:[["luffy","船長，因為我要成為最自由的人"],["zoro","戰鬥主力，擋在大家前面"],["nami","航海士，沒有我你們會迷路"],["sanji","廚師，餵飽大家也是戰力"],["usopp","狙擊手兼氣氛擔當"],["chopper","船醫，夥伴的健康我來守護"]]},
  ...
  { q:"抽到喬巴帽周邊商品時，你會？", a:[["luffy","戴上去大喊出航"],["zoro","看起來不錯，默默收好"],["nami","先拍照，再提醒大家留言參加"],["sanji","戴得很帥，拍一張最有氛圍的"],["usopp","說這是我偉大船員的證明"],["chopper","嘴上說才沒有開心，其實超開心"]]}
];
const results={
