...
const questions = [
  ...
  { q:"夥伴遇到危機時，你最可能？", a:[["luffy","直接衝過去，邊跑邊喊他的名字"],["zoro","冷靜出手，事情交給我"],["nami","先判斷局勢，找出最有效的解法"],["sanji","優雅登場，順便說一句帥話"],["usopp","嘴上說完蛋，但手已經開始出招"],["chopper","先救人，再把對方罵到知道錯"]]},
  ...
  { q:"拿到樂高®喬巴帽時，你會？", a:[["luffy","戴上去大喊出航"],["zoro","看起來不錯，默默收好"],["nami","先拍照，再確認領取規則有沒有看清楚"],["sanji","戴得很帥，拍一張最有氛圍的"],["usopp","說這是我偉大船員的證明"],["chopper","嘴上說才沒有開心，其實超開心"]]}
];
const results={
  ...
  usopp:{icon:"🎯",title:"騙人布型",subtitle:"怕歸怕，關鍵時刻還是超可靠",keywords:["想像力","臨場反應","嘴砲力","關鍵救援"],description:"你可能會先緊張、先吐槽、先說事情不妙，但最後還是會站出來。你的腦袋永遠有奇招，嘴上說不要，身體卻很誠實地幫大家解危。",position:"你適合在大家以為沒辦法的時候，突然拿出一個超乎預期的解法。<br />你的厲害，常常要到最後一刻才會被看見。",products:[["主推盒組","75644 多利 vs. 布洛基－小花園的巨人","巨人戰場加上奇招變化，最適合腦洞很多的你。"],["延伸推薦","75646 卡普的海軍戰艦","想把想像力搬到大船上，就從這艘戰艦開始。"]]},
  chopper:{icon:"💙",title:"喬巴型",subtitle:"嘴上說才不開心，帽子已經開心到飛起來",keywords:["療癒","善良","認真","守護夥伴"],description:"你是大家的補血站，也是船上最想保護別人的人。你在意夥伴的狀態，會默默記住每個人的需要。被稱讚時可能會嘴硬，但心裡早就開花。",position:"你適合成為大家最安心的存在。<br />冒險路上有你在，就算受傷、跌倒或迷惘，也會有人願意好好接住。",products:[["主推盒組","75643 多尼多尼喬巴","最適合療癒又認真的你，把喬巴的可愛與守護力一起收藏。"],["延伸推薦","75641 Dr. 西爾爾克的藏身處","想收藏喬巴故事的起點，就走進那座雪山裡的溫暖藏身處。"]]}
};
