...
const questions = [
  ...
  { q:"夥伴遇到危機時，你最可能？", a:[["luffy","直接衝過去，邊跑邊喊他的名字"],["zoro","冷靜出手，事情交給我"],["nami","先判斷局勢，找出最有效的解法"],["sanji","優雅登場，順便說一句帥話"],["usopp","嘴上說完蛋了，但手已經開始想出招"],["chopper","先救人，再把對方罵到知道錯"]]},
...
const results={
  ...
  usopp:{icon:"🎯",title:"騙人布型",subtitle:"怕歸怕，關鍵時刻還是超可靠",keywords:["想像力","臨場反應","嘴砲力","關鍵救援"],description:"你可能會先緊張、先吐槽、先說事情不妙，但最後還是會站出來。<span class=\"mobile-usopp-desc-break\"></span>你的腦袋永遠有奇招，嘴上說不要，身體卻很誠實地幫大家解危。",position:"你適合在大家以為沒辦法的時候，突然拿出一個超乎預期的解法。你的厲害，常常要到最後一刻才會被看見。",products:[["主推盒組","75644 多利 vs. 布洛基－小花園的巨人","巨人戰場加上奇招變化，最適合腦洞很多的你。"],["延伸推薦","75646 卡普的海軍戰艦","想把想像力搬到大船上，就從這艘戰艦開始。"]]},
